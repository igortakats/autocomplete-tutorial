...
import javax.faces.model.SelectItem;
	...
	@ManagedBean(name= TesteIceMBean.BEAN_NAME)
	@CustomScoped(value = "#{window}")
	public class TesteIceMBean implements Serializable {

	    /**
		 * 
		 */
		private static final long serialVersionUID = -4298535458598432554L;
		public static final String BEAN_NAME = "TesteMBean";
